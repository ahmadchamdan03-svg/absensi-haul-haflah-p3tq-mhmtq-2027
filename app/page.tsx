        ...
        <div className="relative z-10 flex flex-col lg:flex-row lg:items-center justify-between gap-8">
          <div className="space-y-4 max-w-3xl">
            ...
            <div className="pt-1 flex flex-wrap items-center gap-4 sm:gap-6">
              ...
              {/* Logo Kuda Api Islami Terbaru - Cukup Tampilkan Logonya Saja */}
              <img
                src="/images/logo-kuda-api.png"
                alt="Logo Tema Kuda Api Haul Haflah"
                className="h-14 sm:h-20 w-auto object-contain drop-shadow-[0_4px_8px_rgba(212,155,91,0.35)] hover:scale-105 transition-transform"
              />
